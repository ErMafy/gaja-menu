...
import { SiGooglemaps, SiWhatsapp } from "@icons-pack/react-simple-icons";
import { Clock, MapPin, Package, Phone, Pizza } from "lucide-react";
        ...
        >
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "linear-gradient(135deg, rgba(255, 255, 255, 0.9), rgba(244, 228, 160, 0.3))",
          ...
          >
            ...
            <div>
              ...
              >
                <div>
                  <Link
                    href="https://wa.me/message/PZDXL5UGLYAXH1"
                    style={{
                      justifyContent: "center",
                      display: "flex",
                      alignItems: "center",
                  ...
                  >
                    <SiWhatsapp size={24} color="default" />
                  </Link>
                </div>
                <div>
                  <Link
                    href="https://maps.app.goo.gl/zo81wVxNipPQpaJ57?g_st=ic"
                    style={{
                      justifyContent: "center",
                      display: "flex",
                      alignItems: "center",
                  ...
                  >
                    <SiGooglemaps size={24} color="default" />
                  </Link>
                </div>
              </div>
            </div>
...
function HoursCard() {
  return (
    <div
      style={{
        background:
          "linear-gradient(135deg, rgba(255, 255, 255, 0.95) 0%, rgba(244, 228, 160, 0.1) 100%)",
    ...
    >
      ...
      >
        ...
        >
          <Clock
            style={{ width: "24px", height: "24px", color: colors.white }}
          />
        </div>
        <h2
          style={{
